...
trait RatingTrait {
    ...
    public function ratingObjectives() {
        ...
        return $this->hasMany($related, 'related_type', 'post_type')
            ...
            ->selectRaw(
                ...
                sum(if(auth_user_id="'.$user_id.'",value,0)) AS rating_my
                '
            )->leftJoin(
                'rating_morph',
                function ($join) {
    ...
    public function getRatingsCountAttribute($value) {
        ...
        //Method Illuminate\Support\Collection<int,Modules\Blog\Models\Rating>::count() invoked with 1 parameter, 0 required.
    ...
    public function ratingAvgHtml() {
        ...
        $rating_url = Panel::get($this)->itemAction('rate_it')->url();
