 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Amenity whereCreatedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Amenity whereDeletedBy($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Amenity whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Amenity whereRelatedType($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Amenity whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Amenity whereUpdatedBy($value)
