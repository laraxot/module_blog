 ...
 * @method static \Kalnoy\Nestedset\QueryBuilder|Category   whereLocale(string $column, string $locale)
 * @method static \Kalnoy\Nestedset\QueryBuilder|Category   whereLocales(string $column, array $locales)
