                    ...
                    <div class="card ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('category_id') ? ' has-danger' : '' }}">
                                            ...
                                            @include('ui::components.alert.feedback', ['field' => 'category_id'])
                                        </div>
                                    </div>
                                </div>
                                --}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('content') ? ' has-danger' : '' }}">
                                            ...
                                            @include('ui::components.alert.feedback', ['field' => 'content'])
                                        </div>
                                    </div>
                                </div>
                                --}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('excerpt') ? ' has-danger' : '' }}">
                                            ...
                                            @include('ui::components.alert.feedback', ['field' => 'excerpt'])
                                        </div>
                                    </div>
                                </div>
                                --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('tags') ? ' has-danger' : '' }}">
                                        ...
                                        {{--
                                        @include('ui::components.alert.feedback', ['field' => 'tags'])
                                        --}}
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-check" style="margin-top:-6px;">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="checkbox" name="show_on_homepage"
                                                ...
                                                wire:model="form_data.show_on_homepage">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('pulish_date') ? ' has-danger' : '' }}">
                                            ...
                                            @include('ui::components.alert.feedback', ['field' => 'publish_date'])
                                        </div>
                                    </div>
                                </div>
                                --}}
                        ...
                        <div class="card-footer ml-auto mr-auto">
                            <button type="submit" class="btn btn-rose"
                                wire:click="store()">{{ __('Add article') }}</button>
                            <x-flash-message />
                        </div>
                    </div>
